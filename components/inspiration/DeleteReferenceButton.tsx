...
import { deleteReferencePostAction } from "@/app/inspiration/actions";

export default function DeleteReferenceButton({ postId }: { postId: number }) {
        ...
        <button
          ...
          onClick={() =>
            startTransition(async () => {
              await deleteReferencePostAction(postId);
            })
          }
          disabled={isPending}
